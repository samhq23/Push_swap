...
/*   Updated: 2025/11/16 19:30:06 by farhan           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    ft_set_cost(t_stack_node *a, t_stack_node *b)
{
    ...
    while (current)
    {
        if (current->above_median)
            current->cost_a = current->index;
        else
            current->cost_a = current->index - len_a;
        if (current->target_node->above_median)
            current->cost_b = current->target_node->index;
        else
            current->cost_b = current->target_node->index - len_b;
